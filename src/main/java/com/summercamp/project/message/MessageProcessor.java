...
public class MessageProcessor {
    ...
    private static final String HELP_TEXT = """
            ...
            12. 发送“帮我制定大学生健康生活方案”：进入智能健康生活 Agent，自动拆解 RAG、计算、待办等子任务并产出完整方案
            13. 发送“JSON格式化：{内容}”：校验并美化 JSON
            14. 发送“计算 125*36”：直接使用本地计算 Skill
            15. 项目配置和河南师范大学问题会先检索本地知识库，再由模型回答
            16. /clear：清除当前用户的对话记录和待补充意图
            17. /help：查看本帮助
            当前版本暂不处理文件和视频。
            """;
